...
//     let newStaff =  document.createElement('li');
//     let name = document.createElement('a');
//     name.classList.add("name");
//     name.textContent = array[idx]['firstName'] + ' ' + array[idx]['lastName'];
//     newStaff.appendChild(name);
//     name.onclick = function(){
//       printRole(array[idx]);
//     }
//     let age = document.createElement('div');
//     age.classList.add("age");
//     age.textContent = array[idx]['age'];
//     newStaff.appendChild(age);
//     ul.appendChild(newStaff);
//   }
